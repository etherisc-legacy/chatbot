...
function addToStatus(dappUrl) {
  var deviceIP = process.env.IP || 'localhost';
  //console.log("./node_modules/.bin/status-dev-cli add --dappUrl " + dappUrl + " --botUrl " + (dappUrl + BOT_SITE_PATH) + " --ip " + deviceIP);
  child.exec(
...
function run(port) {
  ...
  var host = process.env.HOST || 'localhost'; // we don't support other hosts at this moment
